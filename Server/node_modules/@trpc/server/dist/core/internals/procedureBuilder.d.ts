...
declare type OverwriteIfDefined<TType, TWith> = UnsetMarker extends TType ? TWith : Simplify<FlatOverwrite<TType, TWith>>;
...
export interface ProcedureBuilder<TParams extends ProcedureParams> {
     ...
     */
    use<$Params extends ProcedureParams>(fn: MiddlewareFunction<TParams, $Params>): CreateProcedureReturnInput<TParams, $Params>;
    /**
