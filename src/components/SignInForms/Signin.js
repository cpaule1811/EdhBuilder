...
function Signin() {
  ...
  return (
    <div className="background">
      <div
        className={`container ${signInRegister && "right-panel-active"}`}
        id="container"
      >
        <div className="form-container sign-up-container">
          <form>
            ...
            <button onClick={(e) => handleSignUp(e)} className="signin-button">
              Sign Up
            </button>
            <button
              onClick={(e) => {
                e.preventDefault();
                toggleSignInRegister(false);
              }}
        ...
        <div className="overlay-container">
          <div className="overlay">
            <div className="overlay-panel overlay-left">
              ...
              <button
                onClick={() => toggleSignInRegister(false)}
            ...
            <div className="overlay-panel overlay-right">
              ...
              <button
                onClick={() => toggleSignInRegister(true)}
                className="signin-button ghost"
                id="signUp"
              >
                Sign Up
