    ...
    <div className="how-to-container">
      ...
      <div className="search-bar-explanation-container">
        <div className="search-bar-explanation-wrapper">
          ...
          List view will show you all the cards in your dec. You can delete
          cards by clicking on them.
        </div>
        <div className="search-bar-explanation-wrapper">
          <div className="explanation-icon-container center">
            <img src={image} alt="" width="30px" />
          </div>
          Image view will give you a closer look at your cards and let you
          remove or edit them.
        </div>
        <div className="search-bar-explanation-wrapper">
          <div className="explanation-icon-container">
          ...
          Recommended view will let you see what cards other people are using
          for your chosen commander.
        </div>
        <div className="search-bar-explanation-wrapper">
          <div className="explanation-icon-container">
            <img src={edit} alt="" width="30px" />
          </div>
          Edit view will let you edit the details of your deck and change your
          commander.
        </div>
        <div className="dashboard-prompt">
          You can go back to dashboard at anytime to look at other people's
          decks for inspiration.
        </div>
      </div>
    </div>
  );
