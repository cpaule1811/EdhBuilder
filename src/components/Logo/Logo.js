...
function Logo() {
    ...
    return (
        <div className="logo">
            <div className="logo-wrapper"><div className="logo-container"><img src={logo} alt="logo"></img></div>
            <span id="logo-text">EDH BUILDER</span></div>
                <div onClick={() => dispatch(setMenuStatus(!menuStatus))} className={menuClass}>
                    <span></span>
                    <span></span>
                    <span></span>
                </div>
