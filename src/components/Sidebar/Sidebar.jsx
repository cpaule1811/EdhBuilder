...
function Sidebar() {
  ...
  const { isSignedIn, username, profile, userId } = useSelector(
  ...
  return (
    <div className={`sidebar ${!menuStatus && "hide-menu"}`}>
      <div
        ...
        style={{ backgroundImage: `url(${backMenu})`, backgroundSize: "cover" }}
      />
      ...
      <div className="sidebar-container">
          ...
          <div className={`tabs-dropdown ${showProfileMenu ? null : "hidden"}`}>
            {isSignedIn ? (
              <>
                ...
                {userId === Number(import.meta.env.VITE_ADMIN) ? (
                  <Link to="/adminaddentrys">
                    <div
                      onClick={() => dispatch(setMenuStatus(!menuStatus))}
                      className={
                        location === "/adminaddentry"
                          ? "active-tab tab-dropdown"
                          : "tab tab-dropdown"
                      }
                    >
        ...
        <div className="tabs">
          <Link to="/">
            <div
              onClick={() => dispatch(setMenuStatus(!menuStatus))}
              className={location === "/" ? "active-tab" : "tab"}
            >
          ...
          <Link to="/yourdecks">
            <div
              onClick={() => dispatch(setMenuStatus(!menuStatus))}
              className={location === "/yourdecks" ? "active-tab" : "tab"}
            >
          ...
          <Link to="/adddeck">
            <div
              onClick={() => dispatch(setMenuStatus(!menuStatus))}
              className={location === "/adddeck" ? "active-tab" : "tab"}
            >
        ...
        <div className="tabs tabs-two">
          <Link to="/howto">
            <div
              onClick={() => dispatch(setMenuStatus(!menuStatus))}
              className={location === "/howto" ? "active-tab" : "tab"}
            >
              <img
                src={questionMark}
                alt="icon"
          ...
          <Link to="/contact">
            <div
              onClick={() => dispatch(setMenuStatus(!menuStatus))}
              className={location === "/contact" ? "active-tab" : "tab"}
            >
